...
// Request PTZ Status
robonect.prototype.ptzStatus = function () {
    	var self = this;
...
function handleData(self, data) {
	parser.parseString(data, function(err, result) {
		if (result) {
			...
			// give codes returned by lawn mower prettier and standardized description
